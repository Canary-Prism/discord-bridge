...
package canaryprism.discordbridge.kord.message;
...
public record AttachmentImpl(DiscordBridgeKord bridge, dev.kord.core.entity.Attachment attachment) implements Attachment {

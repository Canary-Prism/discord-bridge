...
public record SlashCommandInteractionOptionSubcommandGroupImpl(DiscordBridge bridge, String name, List<SlashCommandInteractionOptionSubcommandImpl> options) implements SlashCommandInteractionOption {

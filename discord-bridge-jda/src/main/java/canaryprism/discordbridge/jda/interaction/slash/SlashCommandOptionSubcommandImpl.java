...
public record SlashCommandOptionSubcommandImpl(DiscordBridge bridge, Command.Subcommand subcommand) implements SlashCommandOption {
    
    @Override
    public @NotNull SlashCommandOptionType getType() {
        return SlashCommandOptionType.SUBCOMMAND;
    }
    ...
    public @NotNull Map<Locale, @NotNull String> getNameLocalizations() {
        return subcommand.getNameLocalizations()
                .toMap()
                .entrySet()
                .stream()
                .map((e) -> Map.entry(
    ...
    public @NotNull Map<Locale, @NotNull String> getDescriptionLocalizations() {
        return subcommand.getDescriptionLocalizations()
                .toMap()
                .entrySet()
                .stream()
                .map((e) -> Map.entry(

...
public interface MessageRequestDelegate<T extends ResponseBuilder<T>> extends ResponseBuilder<T> {
    
    @NotNull MessageRequest<?> getMessageCreateRequest();
    
    @SuppressWarnings("unchecked")
    @Override
    default @NotNull T setContent(@NotNull String text) {
        getMessageCreateRequest().setContent(text);
        return ((T) this);
    }
}
